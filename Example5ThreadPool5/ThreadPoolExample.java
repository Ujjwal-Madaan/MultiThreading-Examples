...
public class ThreadPoolExample
{
	...
	// Creating five new tasks
		...
		System.out.println("Sending task 1");
		pl.execute(rb1);
		System.out.println("Sent task 1");

		System.out.println("Sending task 2");
		pl.execute(rb2);
		System.out.println("Sent task 2");

		System.out.println("Sending task 3");
		pl.execute(rb3);
		System.out.println("Sent task 3");

		System.out.println("Sending task 4");
		pl.execute(rb4);
		System.out.println("Sent task 4");

		System.out.println("Sending task 5");
		pl.execute(rb5);
		System.out.println("Sent task 5");


		System.out.println("Sent all the tasks");
